...
export GAZEBO_RESOURCE_PATH=/usr/local/share/citysim-0/:$GAZEBO_RESOURCE_PATH

# add path to gazebo models from citysim_resources
export GAZEBO_MODEL_PATH=/usr/local/share/citysim-0/models:$GAZEBO_MODEL_PATH

# Add the directories containing our Gazebo plugins to GAZEBO_PLUGIN_PATH.
export GAZEBO_PLUGIN_PATH=/usr/local/lib/citysim-0/plugins:$GAZEBO_PLUGIN_PATH
